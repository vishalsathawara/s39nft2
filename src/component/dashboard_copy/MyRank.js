  ...
  return (
    <div className="px-8 w-full flex h-fit justify-between flex-col  ">
      ...
      <section className="box-border block ">
        ...
        <div className="border-t-[1px] border-slate-400 pt-6 flex gap-6 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]   grid-cols-2 h-28 ">
          ...
          <div className=" w-1/6 flex items-center justify-center   ">
            <button className="  items-center justify-center rounded bg-sky-500/50 h-11 w-24 text-slate-50 m-1.5">
              Leg Rules
            </button>
          </div>
        </div>
      </section>
      <section className="mt-6">  {/** red border div  */}
        ...
        <div className="flex-col border-2 mb-4 rounded border-green-400">
          ...
          <div className="mb-4 mt-6 flex flex-nowrap justify-center">
            <p className="m-2">i</p>
            <p className="text-sm font-normal w-[calc(100%-28px)] break-words">
              To reach the rank, your team turnover required for raising the
              rank must be the following proportions: no more than 2 500 EUR in
              the strongest leg, 1 500 EUR in the second strongest leg and 1 000
              EUR from all other legs.
            </p>
            <div>
